...
export default function ZonePage({ params }) {
  ...
  // Filter offers for this zone's currency
        ...
        <div className="container py-6">
          ...
          {isConnected && !isLoading && (
            <div className="space-y-6">
              {/* Access Gate */}
              {!hasAccess && (
                <Card className={pendingCred ? "border-amber-200" : ""}>
                  <CardHeader>
                    <CardTitle className="text-base flex items-center gap-2">
                      ...
                      {pendingCred ? "Credential Pending Acceptance" : "Access Denied"}
                    </CardTitle>
                    <CardDescription>
                      {pendingCred
              ...
              {/* Credential Status (when unlocked) */}
              {hasAccess && (
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-medium text-sm">
                        {zone.credentialType} credential verified
                      </span>
                  ...
                  <CardContent>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-muted-foreground">({zone.currencyName})</span>
                      </div>
                      {hasTrustLine ? (
                        <div className="flex items-center gap-3">
                          <span className="text-sm font-medium">
                            Balance: {parseFloat(balance).toLocaleString()} {zone.currency}
                          </span>
